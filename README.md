...
>
> $$\mathbb{E}\left\lbrack \underbrace{\prod_{i=0}^\infty X_i}_{fdsfd} \right\rbrack\text{ v.s. }\mathbb{E}\big\lbrack \prod_{i=0}^{\infty} \underbrace{X_i}_{\text{ran var.}} \big\rbrack$$ 
